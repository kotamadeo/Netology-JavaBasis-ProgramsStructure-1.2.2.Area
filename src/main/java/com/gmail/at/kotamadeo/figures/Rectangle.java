...
public class Rectangle extends Figure {
    ...
    protected void calculateArea() {
        resultArea = side * secondSide;
    }

    @Override
    protected void calculatePerimeter() {
        resultPerimeter = 2 * (side + secondSide);
    }

    @Override
    protected void printSubMenu() {
        System.out.println(Utils.ANSI_YELLOW + "Вы выбрали прямоугольник." + Utils.ANSI_RESET);
        ...
        System.out.println("1: ввести длины сторон (a, b) через пробел.");
            ...
            try {
                ...
                if ("0".equals(input) || "выход".equalsIgnoreCase(input)) {
                    ...
                    switch (operationNumber) {
                        case 1:
                            System.out.println(Utils.ANSI_BLUE + "Введите длины сторон (a,b) через пробел:" +
                                    Utils.ANSI_RESET);
                            input = scanner.nextLine();
