...
public class Circle extends Figure {
    ...
    protected void calculateArea() {
        resultArea = P * side * side;
    }

    @Override
    protected void calculatePerimeter() {
        resultPerimeter = 2 * P * side;
    }

    @Override
    protected void printSubMenu() {
        System.out.println(Utils.ANSI_YELLOW + "Вы выбрали круг." + Utils.ANSI_RESET);
        ...
        System.out.println("1: ввести радиус.");
            ...
            try {
                ...
                if ("0".equals(input) || "выход".equalsIgnoreCase(input)) {
                    ...
                    switch (operationNumber) {
                        case 1:
                            System.out.println(Utils.ANSI_BLUE + "Введите радиус:" + Utils.ANSI_RESET);
                            input = scanner.nextLine();
